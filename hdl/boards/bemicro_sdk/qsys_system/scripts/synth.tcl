# -----------------------------------------------------------------
# boards/bemicro_sdk/qsys_system/scripts/synth.tcl
#
...
puts ""
puts "Synthesizing the BeMicro-SDK 'qsys_system' design"
puts "-------------------------------------------------"
...
#   hdl/boards/bemicro_sdk/qsys_system, so strip off the last
