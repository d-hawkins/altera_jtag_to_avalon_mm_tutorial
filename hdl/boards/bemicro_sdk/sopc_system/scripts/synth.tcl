# -----------------------------------------------------------------
# boards/bemicro_sdk/sopc_system/scripts/synth.tcl
#
...
puts ""
puts "Synthesizing the BeMicro-SDK 'sopc_system' design"
puts "-------------------------------------------------"
...
#   hdl/boards/bemicro_sdk/sopc_system, so strip off the last
...
set_global_assignment -name SYSTEMVERILOG_FILE $src/bemicro_sdk.sv
